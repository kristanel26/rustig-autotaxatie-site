...
import { Phone, Car, Shield, Scale, Wrench, ClipboardList, MessageCircle, MapPin, FileCheck, Handshake } from "lucide-react";
    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="py-16 md:py-20" style={{ background: '#1d3c71' }}>
        <div className="max-w-7xl mx-auto px-6 lg:px-8 text-center">
          ...
          <h1
            className="heading-display font-bold text-white mb-5"
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <h2
              ...
              style={{ fontSize: 'clamp(28px, 3.5vw, 40px)', lineHeight: 1.15, letterSpacing: '-0.02em', color: '#1a1a1a' }}
            >
            ...
            {stappen.map((stap, i) => (
              <div key={i} className="flex gap-6">
                ...
                <div className="flex flex-col items-center">
                  ...
                  {i < stappen.length - 1 && (
                    <div className="w-0.5 flex-1 my-1" style={{ background: '#ff751f', opacity: 0.3 }} />
                  )}
                </div>

                {/* Content */}
                <div className="pb-10">
                  <h3 className="font-semibold text-lg mb-2" style={{ color: '#1d3c71' }}>{stap.title}</h3>
                  <p style={{ fontFamily: "'Inter', sans-serif", fontSize: 14, lineHeight: 1.75, color: '#4a5568' }}>
                    {stap.text}
                  </p>
                </div>
              </div>
      ...
      <section className="py-16 md:py-20" style={{ background: '#1d3c71' }}>
        <div className="max-w-7xl mx-auto px-6 lg:px-8 text-center">
          <h2 className="heading-display font-bold text-white mb-4" style={{ fontSize: 'clamp(28px, 3.5vw, 40px)', lineHeight: 1.15 }}>
            Taxatie nodig?
          </h2>
          <p style={{ fontFamily: "'Inter', sans-serif", fontSize: 16, color: 'rgba(255,255,255,0.78)', lineHeight: 1.7, maxWidth: 480 }} className="mx-auto mb-8">
