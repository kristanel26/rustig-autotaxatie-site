  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <LandingHero
        ...
        description={<>Met een verzekeringstaxatie leg jij de waarde vooraf vast.<br />Wij komen op locatie bij jouw youngtimer.</>}
          ...
          <div className="grid md:grid-cols-[1fr_0.7fr] gap-8 items-start">
            <div>
              ...
              <p className="text-[15px] leading-relaxed mb-5" style={{ color: '#4a5568' }}>
                Jouw youngtimer is meer dan alleen een voertuig. Met een verzekeringstaxatie leg jij vast wat het op dit moment werkelijk waard is. Die waarde vormt de basis voor de verzekering, zodat je bij schade of diefstal niet afhankelijk bent van een dagwaarde.
              </p>
      ...
      <section className="py-14 md:py-16 px-6 md:px-8" style={{ background: '#f7f8fa' }}>
        <div className="container-wide">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mt-10">
            ...
            <Link to="/youngtimer-taxatie-stappenplan">
      ...
      <BekijkOok links={["Oldtimer taxatie", "BPM Taxatie", "Verzekeringstaxatie"]} />
