...
const OldtimerTaxatie = () => {
  ...
  return (
    <div className="min-h-screen bg-background">
      <PageMeta title="Oldtimer Taxatie | Erkend Rapport | Automobiel Taxaties" description="Professionele oldtimer taxatie voor verzekering en waardebepaling. Oog voor detail en historie. Op locatie in het grootste gedeelte van Nederland." />
      <SiteHeader />
      ...
      <section className="py-10 md:py-12 px-6 md:px-8" style={{ background: '#f0f4f8' }}>
        <div className="container-wide"><div className="max-w-3xl mx-auto text-center">
          <h2 className="text-2xl md:text-3xl font-semibold mb-3">Waarom een verzekeringstaxatie voor je oldtimer?</h2>
          <p className="text-[15px] leading-relaxed" style={{ color: '#4a5568' }}>Bij veel verzekeraars is een taxatierapport vereist wanneer de waarde van een oldtimer afwijkt van standaard verzekeringsbedragen. Met een taxatierapport wordt de waarde vooraf vastgelegd.</p>
        </div></div>
      </section>
      ...
      <section className="py-10 md:py-12 px-6 md:px-8 bg-background">
        <div className="container-wide"><div className="grid md:grid-cols-2 gap-8 items-center">
          <div>
            ...
            <p className="text-[15px] leading-relaxed" style={{ color: '#4a5568' }}>Een verzekeringstaxatie is relevant wanneer de waarde van je oldtimer niet vanzelfsprekend is.</p>
          </div>
          <div className="grid grid-cols-2 gap-4">
            {[{ label: "Gerestaureerd", desc: "Waarde hoger dan catalogus" }, { label: "Zeldzaam model", desc: "Beperkte referenties beschikbaar" }, { label: "Afwijkende waarde", desc: "Hoger dan standaard bedragen" }, { label: "Eis verzekeraar", desc: "Verzekeraar vraagt om taxatie" }].map((item, i) => (
      ...
      <section className="py-10 md:py-12 px-6 md:px-8" style={{ background: '#f0f4f8' }}>
        ...
        <div className="grid md:grid-cols-5 gap-5">
          {[{ step: 1, title: "Gegevens aanleveren", desc: "Type, bouwjaar, historie en bijzonderheden" }, { step: 2, title: "Fysieke inspectie", desc: "Staat, originaliteit en uitvoering" }, { step: 3, title: "Waarde vaststellen", desc: "Op basis van inspectie en marktgegevens" }, { step: 4, title: "Rapport opstellen", desc: "Duidelijk hoe de waarde tot stand is gekomen" }, { step: 5, title: "Oplevering", desc: "Digitaal, klaar voor de verzekeraar" }].map((s) => (
      ...
      <section className="py-12 md:py-14 px-6 md:px-8" style={{ background: '#1d3c71' }}>
        <div className="container-wide text-center">
          <h2 className="text-2xl md:text-3xl font-semibold text-white mb-3">Verzekeringstaxatie voor je oldtimer?</h2>
      ...
      <section className="py-6 px-6 md:px-8" style={{ background: '#f0f4f8' }}>
        <div className="container-wide"><div className="flex flex-wrap justify-center gap-6 md:gap-14 items-center">
          ...
          <div className="text-center"><span className="text-lg font-bold text-foreground">Landelijk</span><span class="text-xs ml-1" style={{ color: '#4a5568' }}>werkzaam in groot deel van NL</span></div>
        </div></div>
      </section>
      ...
      <section className="py-12 md:py-14 px-6 md:px-8" style={{ background: '#1d3c71' }}>
        <div className="container-wide text-center">
          <h2 className="text-2xl md:text-3xl font-semibold text-white mb-3">Zekerheid over de waarde van je oldtimer?</h2>
