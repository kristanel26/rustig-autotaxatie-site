    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="section-padding bg-background">
        <div className="container-narrow">
          ...
          <p className="text-foreground/90 leading-relaxed mb-6">
            Deze registraties zijn voor verzekeraars een belangrijk uitgangspunt bij het accepteren van taxatierapporten. Onze taxatierapporten worden door verzekeraars gebruikt om de verzekerde waarde van foodtrucks vast te leggen.
          </p>
          <p className="text-foreground/90 leading-relaxed">
