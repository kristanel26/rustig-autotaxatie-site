...
const BpmVoorbereiding = () => {
  ...
  return (
    <div className="min-h-screen bg-background">
      <PageMeta title="BPM Voorbereiding | Vooraf Weten Wat Je Betaalt | Automobieltaxaties" description="Overweeg je een auto te importeren? Met een BPM voorbereiding weet je vooraf precies wat de totale kosten zijn." />
      <SiteHeader />
