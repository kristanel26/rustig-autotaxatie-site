...
const faqItems = [
  {
    ...
    questions: [
      { q: "Welke manieren van BPM-aangifte zijn er?", a: "Er zijn drie methoden: de forfaitaire afschrijvingstabel, de koerslijst en het taxatierapport. Je mag de methode kiezen die voor jou het meest gunstig is. Wij bepalen dat vooraf voor je." },
      ...
      { q: "Heeft een taxatierapport alleen zin bij schadeauto's?", a: "Nee. Of een taxatie loont hangt af van de nieuwprijs, de huidige handelsinkoopwaarde, de bruto BPM, de CO2-uitstoot, de kilometerstand en de leeftijd. Wij berekenen vooraf kosteloos of het iets oplevert." },
      ...
      { q: "Is een taxatierapport ook interessant bij lichte schade?", a: "Ja. Zelfs lichte schade kan de handelsinkoopwaarde aanzienlijk verlagen. Wij beoordelen bij de fysieke inspectie of de schade past bij de leeftijd en kilometerstand." },
      ...
      { q: "Welk BPM-bedrag komt op het kenteken?", a: "Alleen bij nieuwe voertuigen staat het werkelijk betaalde BPM-bedrag in het kentekenregister. Bij gebruikte voertuigen wordt een herrekend bedrag op basis van de leeftijdskorting opgenomen." },
  ...
  },
  {
    ...
    questions: [
      ...
      { q: "Wat heb ik nodig voor een taxatie?", a: "De buitenlandse kentekenpapieren, de aankoopfactuur en het CVO. Een schone en droge auto met voldoende ruimte voor foto's. Bij technische schade ook een diagnose van een dealer of specialist." },
  ...
  },
  {
    ...
    questions: [
      { q: "Betekent een betaalbericht dat de BPM akkoord is?", a: "Niet per se. Na betaling heeft de Belastingdienst nog zes werkdagen om de auto op te roepen voor hertaxatie." },
      { q: "Wanneer voert de Belastingdienst een hertaxatie uit?", a: "De Belastingdienst kan willekeurig een auto oproepen voor hertaxatie bij de Dienst Domeinen. Een oproep zegt niets over de kwaliteit van het rapport. Neem contact op als je een oproep ontvangt." },
      { q: "Wat is een naheffingsaanslag BPM?", a: "Als de Belastingdienst het niet eens is met de aangegeven waarde, kan hij een naheffingsaanslag opleggen. Je kunt hiertegen binnen zes weken bezwaar maken. De Belastingdienst kan tot vijf jaar navorderen." },
