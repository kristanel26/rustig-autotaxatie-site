...
const BpmCamperTaxatie = () => {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <SiteHeader />
      <LandingHero subtitle="BPM-TAXATIE CAMPER" title="Zorgvuldig vastgestelde BPM bij import van een camper" description="Bij import van een camper uit het buitenland moet BPM worden aangegeven. De wijze waarop de BPM wordt vastgesteld, heeft direct invloed op de BPM-aangifte en de onderbouwing richting de Belastingdienst." ctaText="BPM-taxatie camper aanvragen" onCtaClick={scrollToForm} heroImage={heroCamper} compact />
      <UspBar />
      ...
      <section className="py-6 px-6 md:px-8 bg-background">
        <div className="container-wide"><div className="flex flex-wrap justify-center gap-6 md:gap-14 items-center">
          ...
          <div className="text-center"><span className="text-lg font-bold text-foreground"><div className="text-center"><span className="text-lg font-bold text-foreground">15 jaar</span><span className="text-xs ml-1" style={{ color: '#4a5568' }}>ervaring</span></div></span><span className="text-xs ml-1" style={{ color: '#4a5568' }}>ervaring</span></div>
      ...
      <section className="py-12 md:py-14 px-6 md:px-8" style={{ background: '#1d3c71' }}>
        <div className="container-wide text-center">
          ...
          <p className="text-[15px] mb-6" style={{ color: 'rgba(255,255,255,0.75)' }}>Vraag vrijblijvend een BPM-taxatie aan voor jouw camper.</p>
          <Button variant="cta" size="lg" onClick={scrollToForm}>BPM-taxatie camper aanvragen<ArrowDown className="w-4 h-4 ml-2" /></Button>
        </div>
      </section>
      ...
      <section className="py-10 md:py-14 px-6 md:px-8 bg-background" ref={formRef}>
        ...
        <div className="grid md:grid-cols-[1fr_380px] gap-8 items-stretch"><div><IntakeForm serviceType="bpm-taxatie camper" formTitle="BPM-taxatie camper aanvragen" formSubtext="Vul onderstaand formulier zo volledig mogelijk in." toelichtingPlaceholder="Geef hier de beschikbare informatie over de camper en de import." submitButtonText="BPM-taxatie camper aanvragen" /></div><ContactSidebar /></div></div>
      </section>
