...
const Contact = () => {
  return (
    <div className="min-h-screen bg-white">
      <PageMeta
        title="Contact | Automobiel Taxaties"
        description="Neem contact op met Automobiel Taxaties. Bel 085 483 2461 of stuur een bericht. Wij reageren binnen één werkdag."
      />
      <SiteHeader />
      ...
      <section className="relative overflow-hidden flex items-center" style={{ height: 420, minHeight: 420, maxHeight: 420 }}>
        <div className="absolute inset-0">
          <img src={heroContact} alt="Contact opnemen met Automobiel Taxaties" className="w-full h-full object-cover" style={{ objectPosition: 'center 20%' }} />
