    ...
    <div className="min-h-screen bg-background">
        ...
        <div className="container-wide">
          <div className="grid md:grid-cols-2 gap-8 items-center">
            <div>
              ...
              <p className="text-[15px] leading-relaxed" style={{ color: '#4a5568' }}>
                Een verzekeringstaxatie is relevant wanneer de waarde van jouw motor niet vanzelfsprekend is voor de verzekeraar.
              </p>
            </div>
      ...
      <section className="py-14 md:py-16 px-6 md:px-8" style={{ background: '#f7f8fa' }}>
        <div className="container-wide">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mt-10">
            ...
            <Link to="/motor-taxatie-stappenplan">
      ...
      <section className="py-12 md:py-14 px-6 md:px-8" style={{ background: 'linear-gradient(135deg, #1d3c71 0%, #2a4f8a 100%)' }}>
        <div className="container-wide text-center">
          <h2 className="heading-display text-2xl md:text-3xl font-bold text-white mb-3">Verzekeringstaxatie voor jouw motor?</h2>
      ...
      <section className="py-12 md:py-14 px-6 md:px-8" style={{ background: 'linear-gradient(135deg, #1d3c71 0%, #2a4f8a 100%)' }}>
        <div className="container-wide text-center">
          <h2 className="heading-display text-2xl md:text-3xl font-bold text-white mb-3">Zekerheid over de waarde van jouw motor?</h2>
      ...
      <BekijkOok links={["Camper taxatie", "Schadevaststelling", "Verzekeringstaxatie"]} />
