...
import { ArrowDown, ArrowRight, CheckCircle, Award, Calendar, Info, Wrench, TrendingUp, FileCheck } from "lucide-react";
...
const MotorTaxatie = () => {
  ...
  const wanneerCards = [
    ...
    { icon: Award, label: "Bijzondere uitvoering", desc: "Custom of zeldzame modellen" },
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <LandingHero
        ...
        description={<>Met een verzekeringstaxatie leg je de waarde vooraf vast.<br />Wij komen op locatie bij je motor.</>}
        ...
        <div className="container-wide">
          <div className="grid md:grid-cols-[1fr_0.7fr] gap-8 items-start">
            <div>
              ...
              <h2 className="heading-display text-2xl md:text-3xl font-bold mb-4" style={{ color: '#1d3c71' }}>Waarom een verzekeringstaxatie voor je motor?</h2>
              <p className="text-[15px] leading-relaxed mb-5" style={{ color: '#4a5568' }}>
                Je motor is meer dan alleen een voertuig. Met een verzekeringstaxatie leg je vast wat het op dit moment werkelijk waard is. Die waarde vormt de basis voor de verzekering, zodat je bij schade of diefstal niet afhankelijk bent van een dagwaarde.
              </p>
        ...
        <div className="container-wide">
          <div className="grid md:grid-cols-2 gap-8 items-center">
            <div>
              ...
              <p className="text-[15px] leading-relaxed" style={{ color: '#4a5568' }}>
                Een verzekeringstaxatie is relevant wanneer de waarde van je motor niet vanzelfsprekend is voor de verzekeraar.
              </p>
            </div>
        ...
        <div className="container-wide">
          ...
          <div className="relative">
            ...
            <div className="grid md:grid-cols-5 gap-5 relative">
              {[
                { step: 1, title: "Gegevens aanleveren", desc: "Type, bouwjaar en gebruik van de motor" },
      ...
      <section className="py-12 md:py-14 px-6 md:px-8" style={{ background: 'linear-gradient(135deg, #1d3c71 0%, #2a4f8a 100%)' }}>
        <div className="container-wide text-center">
          <h2 className="heading-display text-2xl md:text-3xl font-bold text-white mb-3">Verzekeringstaxatie voor je motor?</h2>
      ...
      <section className="py-12 md:py-14 px-6 md:px-8" style={{ background: 'linear-gradient(135deg, #1d3c71 0%, #2a4f8a 100%)' }}>
        <div className="container-wide text-center">
          <h2 className="heading-display text-2xl md:text-3xl font-bold text-white mb-3">Zekerheid over de waarde van je motor?</h2>
