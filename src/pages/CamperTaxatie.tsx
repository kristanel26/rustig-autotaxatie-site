    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="section-padding bg-muted/30">
        <div className="container-narrow">
          ...
          <p className="text-foreground/90 leading-relaxed mb-6">
            Bij veel verzekeraars is een taxatierapport vereist wanneer de waarde van een camper afwijkt van standaard verzekeringsbedragen. Dat is vaak het geval wanneer de waarde niet vanzelfsprekend is.
          </p>
      ...
      <section className="section-padding bg-background">
        <div className="container-narrow">
          ...
          <p className="text-foreground/90 leading-relaxed mb-6">
            Deze registraties zijn voor verzekeraars een belangrijk uitgangspunt bij het accepteren van taxatierapporten. Onze taxatierapporten worden door verzekeraars gebruikt om de verzekerde waarde van campers vast te leggen.
          </p>
          <p className="text-foreground/90 leading-relaxed">
