...
interface PDFCamperValuationContentProps {
...
// LOCKED TEXT - DO NOT MODIFY (identical to KLS gold standard)
...
const PDFCamperValuationContent = ({ report, pageNumber, totalPages }: PDFCamperValuationContentProps) => {
...
export default PDFCamperValuationContent;
