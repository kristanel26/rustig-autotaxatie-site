...
const FIELD_LABELS: Record<string, string> = {
  ...
  tire_bandenmaat: 'Bandenmaat',
  tire_dot: 'DOT-code',
  tire_front_left_brand: 'Merk LV',
  tire_front_left_model: 'Model LV',
  tire_front_left_dot: 'DOT LV',
  tire_front_left_size: 'Bandenmaat LV',
  tire_front_left_profiel: 'Profiel LV',
  tire_front_left_season: 'Seizoen LV',
  tire_front_right_brand: 'Merk RV',
  tire_front_right_model: 'Model RV',
  tire_front_right_dot: 'DOT RV',
  tire_front_right_size: 'Bandenmaat RV',
  tire_front_right_profiel: 'Profiel RV',
  tire_front_right_season: 'Seizoen RV',
  tire_rear_left_brand: 'Merk LA',
  tire_rear_left_model: 'Model LA',
  tire_rear_left_dot: 'DOT LA',
  tire_rear_left_size: 'Bandenmaat LA',
  tire_rear_left_profiel: 'Profiel LA',
  tire_rear_left_season: 'Seizoen LA',
  tire_rear_right_brand: 'Merk RA',
  tire_rear_right_model: 'Model RA',
  tire_rear_right_dot: 'DOT RA',
  tire_rear_right_size: 'Bandenmaat RA',
  tire_rear_right_profiel: 'Profiel RA',
  tire_rear_right_season: 'Seizoen RA',
  rim_type: 'Velgtype',
  tire_advice: 'Bandenadvies',
