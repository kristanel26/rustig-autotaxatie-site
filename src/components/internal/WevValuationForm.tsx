...
export const getInitialWevFormData = (): WevFormData => ({
...
interface WevValuationFormProps {
  data: WevFormData;
  onChange: (field: keyof WevFormData, value: string | boolean) => void;
}
...
export const WevValuationForm = ({ data, onChange }: WevValuationFormProps) => {
  ...
  return (
    <Card>
      <CardHeader>
        <CardTitle className="text-lg">Waardebepaling WEV</CardTitle>
      </CardHeader>
...
export default WevValuationForm;
